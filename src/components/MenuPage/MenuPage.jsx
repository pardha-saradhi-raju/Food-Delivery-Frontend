...
const MenuPage = () => {
  ...
  useEffect(() => {
    ...
    Axios.get('https://food-delivery-app-8z61.onrender.com/resdetails')
      .then((res) => {
...
const handleOpenRazorpay = (data) => {
        ...
        const options = {
            ...
            handler: function (response) {
                ...
                Axios.post('https://food-delivery-app-8z61.onrender.com/verify', { response: response })
                    .then(res => {
                        console.log(res, "37")
    ...
    const handlePayment = (amount) => {
        ...
        Axios.post('https://food-delivery-app-8z61.onrender.com/orders', _data)
            .then(res => {
